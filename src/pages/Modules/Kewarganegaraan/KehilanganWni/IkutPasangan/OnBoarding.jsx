        ...
        <Row className="justify-content-center mb-2">
          <Col lg="10">
            ...
            >
              ...
              Indonesia karena Mengikuti Suami/Istri
            </h4>
            <hr />
          </Col>
        </Row>
        ...
        <Row className="justify-content-center mb-2">
          <Col lg="10">
            ...
            >
              ...
              kewarganegaraan RI karena mengikuti Suami/Istri Pastikan Anda
              telah menyiapkan dokumen dan informasi yang dibutuhkan sebelum
              melanjutkan.
            </p>
          </Col>
        </Row>
