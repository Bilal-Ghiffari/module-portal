      ...
      <div className="d-flex flex-column w-100" style={{ maxWidth: 800 }}>
        ...
        <Row className="justify-content-center mb-2">
          <Col lg="10">
            ...
            >
              Permohonan Kehilangan Kewarganegaraan RI Atas Permohonan Sendiri
              Kepada Presiden
            </h4>
            <hr />
          </Col>
        ...
        <Row className="justify-content-center mb-2">
          <Col lg="10">
            ...
            >
              Anda akan memulai proses permohonan kehilangan kewarganegaraan
              Republik Indonesia atas permohonan sendiri kepada
              presiden.Pastikan Anda telah menyiapkan dokumen dan informasi yang
