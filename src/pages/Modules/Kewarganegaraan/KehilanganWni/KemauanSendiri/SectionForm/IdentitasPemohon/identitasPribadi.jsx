...
import {
  ...
  PEKERJAAN_OPTIONS,
} from "@/pages/Modules/Kewarganegaraan/PernyataanWni/Constant/master";
      ...
      <Box className="form-horizontal">
        ...
        <Row>
          ...
          <Col xs="12" sm="12" md="12" lg="6" xl="5">
            <FormInput
              formik={formik}
              name="noSkNaturalisasi"
              title="Nomor SK Naturalisasi (jika ada)"
              placeholder={"Tulis nomor SK Naturalisasi"}
            />
          </Col>
        </Row>
      </Box>
