      ...
      <div className="d-flex flex-column w-100" style={{ maxWidth: 800 }}>
        ...
        <Row className="justify-content-center mb-2">
          <Col lg="10">
            ...
            >
              Anda akan memulai proses permohonan memperoleh kembali
              kewarganegaraan Indonesia. Pastikan Anda telah menyiapkan dokumen
              dan informasi yang dibutuhkan sebelum melanjutkan.
            </p>
          </Col>
        </Row>
