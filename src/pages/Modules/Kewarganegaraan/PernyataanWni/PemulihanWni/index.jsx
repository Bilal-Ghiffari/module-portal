...
import IdentitasPemohonSection from "./SectionForm/IdentitasPemohon";
import IdentitasKeluargaSection from "./SectionForm/IdentitasKeluarga";
import SuratPermohonanPemulihanWni from "./SectionForm/SuratPermohonan";
...
export default function FormPemulihanWni({ label = "Formulir Permohonan" }) {
  ...
  const allSteps = [
    ...
    },
    {
      ...
      component: <SuratPermohonanPemulihanWni formik={formik} />,
    },
    {
      id: "5",
