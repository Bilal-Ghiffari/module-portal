                  ...
                  >
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>:</td>
                        <td>
                          {values.tempat_lahir_pemohon_text},{" "}
                      ...
                      <tr>
                        ...
                        <td>:</td>
                        <td>{values.kwn_asal_pemohon_text}</td>
                      </tr>
                      <tr>
                        <td style={{ verticalAlign: "top" }}>
                          Status Perkawinan
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <div style={{ marginLeft: 20, marginTop: 10 }}>
                            <div>1. Paspor Asing :</div>
                            <div style={{ marginLeft: 20 }}>
                              <div>
                                - nomor : {values.no_paspor_asing_pemohon}
                              </div>
                              <div>
                                - diterbitkan di :{" "}
                              ...
                              <div>
                                ...
                                {formatDateToIndonesian(
                                  values.tgl_exp_paspor_asing_pemohon
                                )}
                              </div>
                            </div>
                          </div>
                      ...
                      <tr>
                        <td style={{ verticalAlign: "top" }}>
                          Nomor penetapan pengadilan negeri tentang pengangkatan
                          anak
                        </td>
                        <td>:</td>
                        <td>
                          <div>
                            Nomor {values.no_dok_pengangkatan_anak} diterbitkan
                            tanggal{" "}
                            {formatDateToIndonesian(
                              values.tgl_dok_pengangkatan_anak
                            )}
                          </div>
                        </td>
                      </tr>
            ...
            >
              ...
              >
                ...
                >
                  <Checked
                    fontSize="0.95rem"
                    label="Pastikan data yang anda isi pada formulir sudah benar dan sesuai."
                    value="1"
