...
import CouponAnakWnGanda from "./ReedemCoupon";

const OnBoardingPermohonan = ({ formik, setActiveStep, label }) => {
      ...
      <div className="d-flex flex-column w-100" style={{ maxWidth: 800 }}>
        ...
        <Row className="justify-content-center mb-2">
          <Col lg="10">
            ...
            >
              Permohonan Pernyataan Memperoleh Kewarganegaraan Republik
        ...
        <Row className="justify-content-center mb-2">
          <Col lg="10">
            ...
            >
              Anda akan memulai proses permohonan pernyataan memperoleh
              kewarganegaraan RI bagi anak angkat.Pastikan Anda telah menyiapkan
...
export default OnBoardingPermohonan;
