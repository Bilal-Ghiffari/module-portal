...
export const useMultiStepForm = (label, permohonanIdFromUrl) => {
  ...
  // Helper function to process payload based on tempat_lahir
  const processPayloadBasedOnTempatLahir = useCallback((payload) => {
    const processedPayload = { ...payload };

    console.log("PROCESSED PAYLOAD", processedPayload);

    if (processedPayload.tempat_lahir_pemohon === DALAM_NEGERI) {
      delete processedPayload.id_negara_lahir_pemohon;
    } else if (processedPayload.tempat_lahir_pemohon === LUAR_NEGERI) {
      delete processedPayload.id_provinsi_lahir_pemohon;
      delete processedPayload.id_kab_kota_lahir_pemohon;
    }
    ...
    if (processedPayload.tempat_lahir_ayah === DALAM_NEGERI) {
      delete processedPayload.id_negara_lahir_ayah;
    } else if (processedPayload.tempat_lahir_ayah === LUAR_NEGERI) {
      delete processedPayload.id_provinsi_lahir_ayah;
      delete processedPayload.id_kab_kota_lahir_ayah;
    }

    if (processedPayload.tempat_lahir_ibu === DALAM_NEGERI) {
      delete processedPayload.id_negara_lahir_ibu;
    } else if (processedPayload.tempat_lahir_ibu === LUAR_NEGERI) {
      delete processedPayload.id_provinsi_lahir_ibu;
      delete processedPayload.id_kab_kota_lahir_ibu;
    }
