...
import IdentitasPasanganSection from "./views/IdentitasPasangan";
...
import PratinjauFormulirTetapWni from "./views/Pratinjau";
import LoadingInitial from "../../components/Loader";
import { SuccessSubmissionBanner } from "../../components/Banner";

export default function FormPenetapanWni({ label = "Formulir Permohonan" }) {
  ...
  const baseStepsDefinition = [
    ...
    },
    {
      ...
      component: <IdentitasPasanganSection formik={formik} />,
    },
    {
      id: "4",
    ...
    },
    {
      ...
      component: <PratinjauFormulirTetapWni formik={formik} />,
    },
  ];
    ...
    <Box className="bg-white page-content mb-4" sx={{ width: "100%" }}>
      ...
      {loadingGet ? (
        ...
        <SuccessSubmissionBanner
          ...
          redirectUrl={"/kewarganegaraan/pernyataan-wni/tetap-wni"}
        />
      ) : (
        <Box>
