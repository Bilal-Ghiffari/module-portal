...
import { getValidasiCol, getVerifikasiCol } from "../Columns";
...
const Detail = ({ formik }) => {
  ...
  const fetchDetailData = () => {
    ...
    apiGetListApostilleDetailPermohonanRiwayat(id)
      .then((res) => {
        const data = res.data;
        const { no_permohonan, data_dokumen, ...values } = data;
        setData({ ...values, data_document: data.data_dokumen });
  ...
  const informasi_pemohon = [
    { label: "Nama Lengkap", value: sourceData?.fullname_pemohon || "-" },
    { label: "NIK", value: sourceData?.nik_pemohon || "-" },
    { label: "Tempat Lahir", value: sourceData?.tempat_lahir_pemohon || "-" },
    { label: "Tanggal Lahir", value: sourceData?.tanggal_lahir_pemohon || "-" },
    { label: "Jenis Kelamin", value: sourceData?.jenis_kelamin_pemohon || "-" },
    {
      label: "Negara Tempat Tinggal",
      value: sourceData?.id_negara_tinggal_pemohon || "-",
    },
    { label: "Alamat", value: sourceData?.alamat_pemohon || "-" },
  ];
  const informasi_penerima_kuasa = [
    {
      label: "Nama Penerima Kuasa",
      value: sourceData?.nama_penerima_kuasa || "-",
    },
    {
      label: "NIK Penerima Kuasa",
      value: sourceData?.nik_penerima_kuasa || "-",
    },
    {
      label: "Email Penerima Kuasa",
      value: sourceData?.email_penerima_kuasa || "-",
    },
    {
      label: "No HP Penerima Kuasa",
      value: sourceData?.no_hp_penerima_kuasa || "-",
    },
  ];
        ...
        <Row>
          ...
          <>
            ...
            <Col xs="12" md="6" className="mb-2">
              ...
              <FilePreview file={formik?.values?.file_surat_kuasa_bermateri} />
            </Col>
            <Col xs="12" md="6" className="mb-2">
