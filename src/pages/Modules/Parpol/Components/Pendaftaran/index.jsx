...
import DataPartaiPolitik from "./DataPartaiPolitik";
import { StepLabel } from "@mui/material";
import Detail from "../Detail";

const PendaftaranParpol = ({ label = "Pendaftaran Partai Politik" }) => {
  ...
  const allSteps = [
    {
      ...
      component: (
        <OnBoardingPendaftaran
          ...
          label={"Pendirian Partai Politik"}
        />
      ),
    },
    {
      ...
      component: <DataPartaiPolitik formik={formik} label={label} />,
    },
    {
      id: "3",
  ...
  const stepsConfig = {
    "Pendaftaran Partai Politik": ["1", "2", "3"],
  };
...
export default PendaftaranParpol;
