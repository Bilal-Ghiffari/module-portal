...
export const useMultiStepForm = (label, permohonanIdFromUrl) => {
  ...
  const processPayloadBasedOnTempatLahir = useCallback((payload) => {
    ...
    if (processedPayload.tempat_lahir_pasangan === DALAM_NEGERI) {
      delete processedPayload.id_negara_lahir_pasangan;
    } else if (processedPayload.tempat_lahir_pasangan === LUAR_NEGERI) {
      delete processedPayload.id_provinsi_lahir_pasangan;
      delete processedPayload.id_kab_kota_lahir_pasangan;
    }
