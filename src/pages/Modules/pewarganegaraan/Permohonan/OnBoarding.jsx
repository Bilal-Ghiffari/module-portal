      ...
      <div className="d-flex flex-column w-100" style={{ maxWidth: 800 }}>
        ...
        <Row className="justify-content-center mb-2">
          <Col lg="10">
            ...
            >
              Pendaftaran Pewarganegaraan Berdasarkan Perkawinan Campuran
            </h4>
            <hr />
          </Col>
        </Row>
        ...
        <Row className="justify-content-center mb-2">
          <Col lg="10">
            ...
            >
              Anda akan memulai proses pendaftaran pewarganegaraan berdasarkan
              perkawinan campuran. Pastikan Anda telah menyiapkan dokumen dan
