export const indikatorSteps = [
  "Pembelian voucher",
  "Pendaftaran permohonan",
  "Verifikasi oleh Konseptor",
  "Verifikasi oleh Subkoordinator",
  "Verifikasi oleh Koordinator",
  "Verifikasi oleh Direktur",
  "SK Terbit",
];

export const steps = [
  // { label: "Pembelian Voucher", description: "Memulai pembelian voucher" },
  ...
  {
    label: "Verifikasi oleh Sub koordinator",
