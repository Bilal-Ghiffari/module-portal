      ...
      >
        ...
        <>
          ...
          <Box className="form-horizontal border border-1 rounded-4 px-4 py-3">
            <Row>
              <Col md="6">
                {RowField("Dibuat Di Negara", values.negara_pembuatan)}
              </Col>
              <Col md="6">
                {RowField(
                  "Kota Kantor Perwakilan",
                  values.kota_kantor_perwakilan
                )}
              </Col>
            </Row>
            <Row>
              <Col md="6">{RowField("Kota", values.kota_pembuatan)}</Col>
              <Col md="6">
                {RowField(
                  "Nama Kantor Perwakilan RI",
                  values.nama_kantor_perwakilan
                )}
              </Col>
            </Row>
            <Row>
              <Col md="6">
                {RowField(
                  ...
                  values.nomor_penetapan_pengadilan
                )}
              </Col>
              <Col md="6">
                {RowField(
                  "Tanggal Penetapan Pengadilan",
                  values.tanggal_penetapan_pengadilan
                )}
              </Col>
            </Row>
            <Row>
              <Col md="6">
                {RowField(
                  ...
                  values.tanggal_pengesahan_perwakilan
                )}
              </Col>
              <Col md="6">
                {RowField(
                  "Nama Pemohon Penetapan Pengadilan",
                  values.nama_pemohon_pengadilan
                )}
              </Col>
            </Row>
            <Row>
