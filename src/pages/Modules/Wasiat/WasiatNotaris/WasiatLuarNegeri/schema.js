...
const validationSchema = Yup.object().shape({
  ...
  negara_pembuatan: Yup.string().required("Negara pembuatan wajib diisi"),
  kota_pembuatan: Yup.string().required("Kota pembuatan wajib diisi"),
  kota_kantor_perwakilan: Yup.string().required(
    "Kota kantor perwakilan wajib diisi"
  ),
  nama_kantor_perwakilan: Yup.string().required(
    "Nama kantor perwakilan wajib diisi"
  ),
  nomor_penetapan_pengadilan: Yup.string().required(
    "Nomor penetapan wajib diisi"
  ),
  tanggal_penetapan_pengadilan: Yup.date().required(
    "Tanggal penetapan wajib diisi"
  ),
  tanggal_pengesahan_perwakilan: Yup.date().required(
    "Tanggal pengesahan wajib diisi"
  ),
  nama_pemohon_pengadilan: Yup.string().required("Nama pemohon wajib diisi"),
  nama_pengadilan_negeri: Yup.string().required("Nama pengadilan wajib diisi"),
