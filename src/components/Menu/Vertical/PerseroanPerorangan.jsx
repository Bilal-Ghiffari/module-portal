...
const PerseroanPeroranganMenuVertical = (props) => {
  ...
  return (
    <React.Fragment>
      <ul className="metismenu list-unstyled" id="side-menu">
        <li className="menu-title">{props.t("PERSEROAN PERORANGAN")} </li>
        <li>
          <Link to="/perseroan/perorangan">
            {/* <i className="mdi mdi-view-dashboard" /> */}
            <span>{props.t("Dashboard User")}</span>
          </Link>
        </li>
        <li>
          <Link to="/perseroan/perorangan/admin">
            {/* <i className="mdi mdi-view-dashboard" /> */}
            <span>{props.t("Dashboard Admin")}</span>
          </Link>
        </li>
        <li>
          <Link to="/perseroan/perorangan/pendaftaran">
            {/* <i className="mdi mdi-file-plus" /> */}
            <span>{props.t("Pendirian")}</span>
          </Link>
        </li>
        <li>
          <Link to="/perseroan/perorangan/perubahan-data">
            {/* <i className="mdi mdi-pencil" />  */}
            <span>{props.t("Perubahan Data")}</span>
          </Link>
        </li>
        <li>
          <Link to="/perseroan/perorangan/pembubaran">
            <span>{props.t("Pembubaran")}</span>
          </Link>
        </li>
        <li>
          <Link to="/perseroan/perorangan/perbaikan-data">
...
PerseroanPeroranganMenuVertical.propTypes = {
  t: PropTypes.any,
  roles: PropTypes.any,
};

export default withRouter(withTranslation()(PerseroanPeroranganMenuVertical));
